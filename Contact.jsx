...
const [result, setResult] = React.useState("");
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "c8dc9608-790a-4088-879d-39c7276cff1c");
    ...
    <div className='contact'>
         <div className='contact-col'>
            ...
            <p>Feel free to reach out through contact form or find our contact information below.
                ...
                <ul>
                    <li> <img src={mail_icon} alt=''/> Contact@Ehtisham.dev</li>
                      <li><img src={phone_icon} alt=''/>+92 3320563942</li>
                        <li><img src={location_icon} alt=''/>4 Street House 256,Islamabad<br/>F-7,Pakistan</li>
                </ul>
         </div>
